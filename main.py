...
if __name__ == "__main__":
    # final_df = pd.read_csv("audio_features.csv").drop(
    #    columns=["Unnamed: 0"], errors="ignore"
    # )
    # print(final_df)
    test = get_top_100_tracks_for_all_subgenres(METAL_SUBGENRES)
    print(test)
    test_2 = extract_audio_features_from_preview(test)
    test_2.to_csv("kaka.csv")
